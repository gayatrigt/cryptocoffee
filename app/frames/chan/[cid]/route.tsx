      ...
      buttons: !ctx.url.searchParams.has("custom")
        ? [
          <Button
            action="post"
            target={{
              pathname: `/chan/${campaign}/transaction`, query: { amount: "1" }
            }}
          >
            1
          </Button >,
          <Button
            action="post"
            target={{
              pathname: `/chan/${campaign}/transaction`, query: { amount: "2" }
            }}
          >
            2
          </Button >,
          <Button
            action="post"
            target={{
              pathname: `/chan/${campaign}/transaction`, query: { amount: "5" }
            }}
          >
            5
          </Button >,
          <Button action="post" target={{
            pathname: `/chan/${campaign}`,
            query: { custom: true }
          }}>
            Custom
          </Button>, ,
          ...
          <Button
            action="post"
            target={{
              pathname: `/chan/${campaign}/transaction`, query: { customAmount: true }
            }}
          >
            Buy Coffee
          </Button >
